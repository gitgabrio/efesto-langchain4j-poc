...
public final class Msg {
    ...
    public static final Message2 FUNC_DEF_LC4J_MISSING_ENTRY                         = new Message2( DMNMessageType.INVALID_SYNTAX, "A LC4J function definition requires both the 'engine' and the 'model' attributes. Invalid definition for function '%s' on node '%s'" );
